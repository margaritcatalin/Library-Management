...
namespace LibraryManagement.DataMapper
{
    ...
    public class ProductRepository
    {
        ...
        public bool AddProduct(Product product)
        {
            ...
            {
                LoggerUtil.LogError($"Product failed to add to db : {product.Id},{product.Name}", MethodBase.GetCurrentMethod());
            }
        ...
        {  
            ...
            {
                LoggerUtil.LogError($"Product failed to update to db : {product.Id},{product.Name}", MethodBase.GetCurrentMethod());
            }
        ...
        {  
            ...
            if (product != null)
            {
                ...
                LoggerUtil.LogError($"Product failed to delete from db. We don't found a product with id: {id}", MethodBase.GetCurrentMethod());
                return false;
            }
            var successful = this.libraryContext.SaveChanges() != 0;
            if (successful)
