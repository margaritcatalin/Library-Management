...
namespace LibraryManagement.DataMapper
{
    ...
    public class CategoryRepository
    {
        ...
        {  
            ...
            {
                LoggerUtil.LogError($"Category failed to update to db : {category.Name}", MethodBase.GetCurrentMethod());
            }
        ...
        {  
            ...
            if (category != null)
            {
                ...
                LoggerUtil.LogError($"Category failed to delete from db. We don't found a category with id: {id}", MethodBase.GetCurrentMethod());
                return false;
            }
            var successful = this.libraryContext.SaveChanges() != 0;
            if (successful)
